/*
Deployment script for DatabaseBIA
...
GO
:setvar DatabaseName "DatabaseBIA"
:setvar DefaultFilePrefix "DatabaseBIA"
:setvar DefaultDataPath "C:\Users\kmurth\AppData\Local\Microsoft\VisualStudio\SSDT\DatabaseBIA"
:setvar DefaultLogPath "C:\Users\kmurth\AppData\Local\Microsoft\VisualStudio\SSDT\DatabaseBIA"
...
GO
PRINT N'Creating Login [NT AUTHORITY\NETWORK SERVICE]...';
...
GO
PRINT N'Creating Login [NT AUTHORITY\SYSTEM]...';
...
GO
PRINT N'Creating Login [NT Service\MSSQLSERVER]...';
...
GO
PRINT N'Creating Login [NT SERVICE\SQLSERVERAGENT]...';
...
GO
PRINT N'Creating Login [NT SERVICE\SQLTELEMETRY]...';
...
GO
PRINT N'Creating Login [NT SERVICE\Winmgmt]...';
...
GO
PRINT N'Creating Event Session [telemetry_xevents]...';
...
GO
PRINT N'Creating Server Role Membership <unnamed>...';
...
GO
PRINT N'Creating Certificate [_##PDW_PolyBaseAuthorizeSigningCertificate##]...';
...
GO
PRINT N'Creating Certificate [_##PDW_SmDetachSigningCertificate##]...';
...
GO
PRINT N'Creating Login [l_certSignPolyBaseAuthorize]...';
...
GO
PRINT N'Creating Login [l_certSignSmDetach]...';
...
GO
PRINT N'Creating Table [dbo].[Address.sql]...';


GO
CREATE TABLE [dbo].[Address.sql] (
    [AddresssID]   INT        NULL,
    [AddressLine1] NCHAR (60) NULL,
    [City]         NCHAR (60) NULL
);
